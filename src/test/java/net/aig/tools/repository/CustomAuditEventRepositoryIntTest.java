...
import net.aig.tools.config.audit.AuditEventConverter;
import net.aig.tools.domain.PersistentAuditEvent;
...
import static net.aig.tools.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
