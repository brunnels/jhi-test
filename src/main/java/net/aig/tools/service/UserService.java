package net.aig.tools.service;

import net.aig.tools.config.Constants;
import net.aig.tools.domain.Authority;
import net.aig.tools.domain.User;
import net.aig.tools.repository.AuthorityRepository;
import net.aig.tools.repository.UserRepository;
import net.aig.tools.security.SecurityUtils;
import net.aig.tools.service.dto.UserDTO;
